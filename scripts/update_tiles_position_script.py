...
from utils import GlobalSettings, get_global_path, reload_modules, isolated_print, print_title
...
def update_tiles_position(global_settings):
    try:
        ...
        isolated_print(EOL)
        print_title("UPDATE TILE POSITIONS")
