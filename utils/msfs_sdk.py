...
def build_package(msfs_project, settings):
    ...
    try:
        print(fspackagetool_exe_path + " \"" + msfs_project.project_definition_xml_path + "\" " + MSFS_BUILD_EXE_OUTPUT_DIR_OPTION + " \"" + msfs_project.project_folder + "\"")
        subprocess.run(fspackagetool_exe_path + " \"" + msfs_project.project_definition_xml_path + "\" " + MSFS_BUILD_EXE_OUTPUT_DIR_OPTION + " \"" + msfs_project.project_folder + "\"", shell=False, check=True)
    except:
